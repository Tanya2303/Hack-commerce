...
function LogIn() {
  ...
  return (
    ...
    // </div>
    <div>
      <form action="" onSubmit={loginUser} className="min-w-screen min-h-screen flex items-center justify-center px-5 py-5">
          ...
          <div className="md:flex w-full">
            ...
            <div className="w-full md:w-1/2 py-20 px-5 md:px-10">
              ...
              <div>
                ...
                <div className='text-right py-2'>Don't have an account? <Link to="/register"><span className="text-blue-500 underline">Sign Up</span></Link></div>
              </div>
            </div>
          </div>
        </div>
