            ...
            <main className="flex flex-col items-center justify-center mt-4">
                ...
                <div className='md:grid md:grid-cols-2 items-center px-36 py-8'>
                    <div className='text-white'>
                        ...
                        <p className='text-xl md:text-2xl py-4 tracking-wider'>EcoGreen, a website platform that enables users to successfully sell or donate their unused goods and purchase items from other users. We aim to use this platform to bring people together around a common cause and help the world become a cleaner environment.</p>
